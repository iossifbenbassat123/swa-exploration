...
//   // Control point for the curve (adjust curvature here)
//   const curvature = 0.25; // Adjust this value to change arc depth
//   const controlOffset = length * curvature;

//   // Base control point (same for both edges)
