...
interface TopologyEuWestVisxProps {
...
const TopologyEuWestVisx = ({ selectedId, onNodeClick }: TopologyEuWestVisxProps) => {
  ...
  const { nodes, edges, reverseIdMapping } = useMemo(() => {
    ...
    const reverseMapping: Record<string, string> = { "eu-west-root": "eu-west" };
...
export default TopologyEuWestVisx;
